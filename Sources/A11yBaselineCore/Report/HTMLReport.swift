        ...
        <main>
          ...
          <section class="scope">
            ...
            <p>
              ...
              Проверки не зависят от вкуса: прогон можно повторить и сверить
              результат с этой страницей. Совпадение измерено — два одинаковых
              прогона подряд дали одно и то же число элементов в 20 приложениях
              из 24. Там, где приложение догружает содержимое с задержкой,
              обход может пройти разное число экранов.
            </p>
            <p>
          ...
          <footer>
            ...
            <p class="repro">
              Проверка выполнена открытым инструментом, прогон можно повторить:
